...
const Hero = () => {
    return (
        <section className="relative pl-20 py-48 flex flex-col md:flex-row 
                ...
                <BouncyBox delayOffset={2.4}>
                    <ul className="mt-24 flex flex-row items-center gap-2">
                        ...
                        >
                            ...
                            src={github}
                            alt="GitHub"
                            className="w-full h-full object-contain invert opacity-80 hover:opacity-100 transition-opacity"
                            />
                        </a>
                        </li>
                        <li>
